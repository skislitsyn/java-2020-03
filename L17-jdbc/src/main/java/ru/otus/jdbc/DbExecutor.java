...
public interface DbExecutor<T> {
    ...
    Optional<T> executeSelect(Connection connection, String sql, long id, Function<ResultSet, T> rsHandler)
	    throws SQLException;

    long executeUpdate(Connection connection, String sql, List<Object> params, long id) throws SQLException;

    Optional<T> executeSelectAll(Connection connection, String sql, Function<ResultSet, T> rsHandler)
	    throws SQLException;
}
